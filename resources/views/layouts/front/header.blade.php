                        ...
                        @else
                            <li>
                                ...
                                <ul>
                                    ...
                                    @endif
                                    <li><a href="{{ route('user-information') }}">My Account</a></li>
                            ...
                            <ul class="second-links pl-0 m-0">
                                @if (false)
                                    ...
                                    <li class="has-child electric">
                                        <a href="">
                                            <div class="icon-large"><i class="ri-bluetooth-connect-line"></i>
                                            </div>
                                            Electric
                                ...
                                @foreach ($assideMenu as $item)
                                    ...
                                    <li class="{{ $child }}">
                                        <a href="{{ $link }}">
                                            ...
                                            {{ $item->title }}
                                            @if ($item->child)
                                                <div class="icon-small"><i class="ri-arrow-right-s-line"></i>
                                                </div>
                                            @endif
                                        </a>
